...
<table border="0" width="100%" cellpadding="0" cellspacing="0">
	<tr>
		<td width="200">
<iframe style="margin: 2px;" name="adminshouts" width="181" height="148" src="shouts.php?admin=yes" frameborder="0" marginwidth="1" marginheight="1">
Your browser does not support inline frames or is currently configured not to display inline frames.
	...
	{
	echo<<<EOF
	<form style="margin:0px;" name="admin" action="shouts.php?admin=yes" method="POST" target="adminshouts">
