...
echo ("<div width=\"100%\">Welcome $logged[username]! &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <b>User Controls:</b>&nbsp;&nbsp; <a href=\"?view=cpanel\">Member Control Panel</a> &middot; <a href=\"?view=cpanel&mode=profile\">Edit Profile</a> &middot; <a href=\"?view=cpanel&mode=messenger\">Messenger ($num new)</a> &middot; <a href=\"?view=logout\">Logout</a></div>");
 }
if (!$_POST[username]){
if (!$logged[username]){
echo ("
